 ...
 * Deploy
 *
 * @package Pronamic/WordPress/OrbisCreditCases
 */
...
set( 'plugin_slug', 'orbis-credit-cases' );
...
host( 'orbis.pronamic.nl' )
	...
	->set( 'port', 18765 )
	->set( 'deploy_path', '~/projects/wp-orbis-credit-cases' )
...
task(
	'deploy:update_code',
	function () {
		upload( '{{build_path}}/orbis-credit-cases/', '{{release_path}}' );
	}
);
